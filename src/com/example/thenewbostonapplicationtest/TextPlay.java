...
public class TextPlay extends Activity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//sample method creation, we put all our VARs in it
		baconAndEggs();
		/*
		...
		*/
		...
		//set onClick method for the toggle button => change - password/regular text
		passTog.setOnClickListener(this);
		//set onClick method for the regular button => compare the text entered
